...
sleep 2
rtdoc --format=rst /localhost/`hostname`.host_cxt/JabberRTC0.rtc > jabberrtc-ja.rst
rtexit /localhost/`hostname`.host_cxt/JabberRTC0.rtc
...
sleep 2
rtdoc --format=rst /localhost/`hostname`.host_cxt/WebServerRTC0.rtc > webserverrtc-ja.rst
rtexit /localhost/`hostname`.host_cxt/WebServerRTC0.rtc
...
sleep 2
rtdoc --format=rst /localhost/`hostname`.host_cxt/XMLtoJSONRTC0.rtc > xmltojsonrtc-ja.rst
rtexit /localhost/`hostname`.host_cxt/XMLtoJSONRTC0.rtc
